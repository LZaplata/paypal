...
class Column extends \Nette\Application\UI\PresenterComponent
{
	...
	public function setTextEditable($textarea = FALSE, $cols = NULL, $rows = NULL)
	{
		...
		$input->getControlPrototype()->addClass("grid-editable form-control input-sm");
	...
	public function setSelectEditable(array $values, $prompt = NULL)
	{
		...
		$this->parent['gridForm'][$this->parent->name]['rowForm']->addSelect($this->name, NULL, $values)->getControlPrototype()->addClass("grid-editable form-control input-sm");
		if($prompt){
	...
	public function setDateEditable()
	{
		...
		$this->parent['gridForm'][$this->parent->name]['rowForm']->addText($this->name, NULL)->getControlPrototype()->addClass("grid-datepicker form-control input-sm")->addClass("grid-editable");
	...
	{
		$this->parent['gridForm'][$this->parent->name]['filter']->addText($this->name, $this->label.":")->getControlPrototype()->class('form-control input-sm');
	...
	{
		$this->parent['gridForm'][$this->parent->name]['filter']->addSelect($this->name, $this->label.":", $values)->getControlPrototype()->addClass('form-control input-sm');
		if($prompt){
	...
	{
		$this->parent['gridForm'][$this->parent->name]['filter']->addText($this->name, $this->label.":")->getControlPrototype()->class("grid-datepicker form-control input-sm");
